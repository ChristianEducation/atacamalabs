import { ConnectionsVisual } from "@/components/PublicVisuals";
          ...
          <div className="internal-hero">
            <div>
              ...
              <p className="mt-4 max-w-[60ch] text-lg leading-8 text-muted">
                {site.brand.descriptor} Cada solución parte de un problema real
                y termina en un resultado concreto para tu operación.
              </p>
            </div>
            <ConnectionsVisual />
          </div>
